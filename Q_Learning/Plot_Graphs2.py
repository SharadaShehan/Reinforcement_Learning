...
def plot_graph(ax, title, learning_rate = 0.3, discount_rate = 0.95):

        # plot rewards
        rewards = train_model2(learning_rate,discount_rate)
        sns.scatterplot(x=range(len(rewards)), y=rewards, ax=ax, s=2, color='black', legend=False, linewidth = 0)

        # set up labels
        ax.set_title(title, fontsize=12, y=0.4, pad=-14)
...
def plot_alpha_graphs():
        ...
        base_learning_rates = [0.1, 0.5, 0.7, 0.9]
        ...
        plt.suptitle('Scatter plots of Average Reward Values against Number of Episodes for Different Learning Rates', fontsize=20)
...
def plot_gamma_graphs():
        ...
        plt.suptitle('Scatter plots of Average Reward Values against Number of Episodes for Different Discount Rates', fontsize=20)
...
def plot_alpha_against_gamma_graphs():
        ...
        plt.suptitle('Scatter plots of Average Reward Values against Number of Episodes for Different Learning Rates and Discount Rates', fontsize=20)
